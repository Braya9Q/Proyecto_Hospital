...
<html lang="es">
    ...
    <body style="background-image: url(img/imagen.jpg)">
        ...
        <br>
        <h1 style="text-align: center; ">Usua<span>rios</span></h1>
        <table class="container1">
            <tr>
                <th><a href="UsuarioControlador?action=add" class="btn fourth">Crear Nuevo Usuario</a></th>
            ...
            <tbody>
                <c:forEach var="item" items="${usuarios}">
                    <tr>
                        ...
                        <td><a href="UsuarioControlador?action=delete&id=${item.id}" onclick="return(confirm('Desea Eliminar'))"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
